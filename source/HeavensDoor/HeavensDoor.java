    ...
    public static void sortData(List<List<String>> data, String sortingOrder, String sortingDirection) {
        ...
        switch (sortingOrder.toLowerCase()) {
            ...
            case "destructive power":
                comparator = Comparator.comparing(item -> item.get(4), Comparator.nullsLast(Comparator.reverseOrder()));
                break;
            case "speed":
                comparator = Comparator.comparing(item -> item.get(5), Comparator.nullsLast(Comparator.reverseOrder()));
                break;
            case "range":
                comparator = Comparator.comparing(item -> item.get(6), Comparator.nullsLast(Comparator.reverseOrder()));
                break;
            case "stamina":
                comparator = Comparator.comparing(item -> item.get(7), Comparator.nullsLast(Comparator.reverseOrder()));
                break;
            case "precision":
                comparator = Comparator.comparing(item -> item.get(8), Comparator.nullsLast(Comparator.reverseOrder()));
                break;
            case "development potential":
                comparator = Comparator.comparing(item -> item.get(9), Comparator.nullsLast(Comparator.reverseOrder()));
                break;
            default:
        ...
        if (sortingDirection.equalsIgnoreCase("descending")) {
